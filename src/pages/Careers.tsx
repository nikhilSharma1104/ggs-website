...
const Careers: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('/api/careers/apply', formDataToSend, {
        headers: {
  ...
  return (
    <>
      <SEO
        title="Careers"
        description="Join our team at Gurukulam Global School. Explore exciting career opportunities in teaching, administration, and support staff positions. Be part of shaping the future of education."
        keywords={[
          'school jobs',
          'teaching jobs',
          'education careers',
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-white/10 border-dashed rounded-lg hover:border-secondary-500/50 transition-colors">
                    <div className="space-y-1 text-center">
                      ...
                      <p className="text-xs text-white/50">PDF, DOC up to 5MB</p>
                    </div>
                  </div>
                </div>
