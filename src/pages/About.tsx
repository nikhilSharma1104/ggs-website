...
const About: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="About Us"
        description="Learn about Gurukulam Global School's rich history, mission, values, and our commitment to providing quality education. Discover our unique approach to holistic learning and development."
        keywords={[
